...
export const metapool_app = 84517418;
...
export const nanoLT = 77282957; // This is the nanopool liquidity tokens
export const stable1 = 77279127; // D981
export const stable2 = 77279142; // D552
export const metapoolLT = 84517452; // This is the liquidity token of the metapool
